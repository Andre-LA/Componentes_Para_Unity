...
public class Configurador_De_Jogo : MonoBehaviour {
    ...
    void Awake() {
        telaCheia = Screen.fullScreen;
        indiceResolucaoAtual = Encontrar_Indice_Resolucao_Atual();
    }
    ...
    public void Incrementar_Indice_Resolucao_Atual(int inc) {
        ...
        bool estava_no_primeiro_ou_ultimo_indice = indiceResolucaoAtual == 0
                                                 || indiceResolucaoAtual == Screen.resolutions.Length - 1;
